...
// --- LOGOS ---
import logoIzquierda from './assets/att-512.png';
import logoDerecha from './assets/logo_derecha.webp';
...
const Dashboard = () => {
  ...
  const dashboardData = [
    { tienda: "CHEDRAUI EDUARDO MOLINA", zona: "Norte", semana1: { activaciones: 12, renovaciones: 8, seguros: 5, simples: 0, accessFee: 676.50 }, semana2: { activaciones: 7, renovaciones: 5, seguros: 2, simples: 0, accessFee: 659.00 }, semana3: { activaciones: 13, renovaciones: 2, seguros: 0, simples: 0, accessFee: 551.86 }},
    { tienda: "EXP CENTRO TEPOZAN", zona: "Sur", semana1: { activaciones: 34, renovaciones: 12, seguros: 8, simples: 0, accessFee: 509.22 }, semana2: { activaciones: 20, renovaciones: 7, seguros: 5, simples: 2, accessFee: 636.04 }, semana3: { activaciones: 22, renovaciones: 5, seguros: 6, simples: 0, accessFee: 559.38 }},
    { tienda: "EXP CHEDRAUI ANFORA", zona: "Norte", semana1: { activaciones: 30, renovaciones: 10, seguros: 0, simples: 0, accessFee: 564.94 }, semana2: { activaciones: 21, renovaciones: 15, seguros: 4, simples: 0, accessFee: 611.22 }, semana3: { activaciones: 18, renovaciones: 9, seguros: 1, simples: 1, accessFee: 586.60 }},
    { tienda: "EXP CHEDRAUI METEPEC", zona: "Sur", semana1: { activaciones: 14, renovaciones: 4, seguros: 2, simples: 0, accessFee: 755.67 }, semana2: { activaciones: 10, renovaciones: 7, seguros: 1, simples: 0, accessFee: 642.57 }, semana3: { activaciones: 9, renovaciones: 4, seguros: 0, simples: 0, accessFee: 509.00 }},
    { tienda: "EXP COSMOPOL 2", zona: "Norte", semana1: { activaciones: 33, renovaciones: 5, seguros: 5, simples: 0, accessFee: 673.48 }, semana2: { activaciones: 28, renovaciones: 11, seguros: 8, simples: 1, accessFee: 747.00 }, semana3: { activaciones: 23, renovaciones: 14, seguros: 8, simples: 0, accessFee: 676.71 }},
    { tienda: "EXP GALERIAS TOLUCA", zona: "Sur", semana1: { activaciones: 15, renovaciones: 5, seguros: 2, simples: 0, accessFee: 683.12 }, semana2: { activaciones: 7, renovaciones: 0, seguros: 1, simples: 0, accessFee: 627.57 }, semana3: { activaciones: 9, renovaciones: 4, seguros: 2, simples: 0, accessFee: 867.18 }},
    { tienda: "EXP IZTAPALAPA 2", zona: "Sur", semana1: { activaciones: 25, renovaciones: 11, seguros: 4, simples: 1, accessFee: 520.00 }, semana2: { activaciones: 20, renovaciones: 11, seguros: 3, simples: 0, accessFee: 450.54 }, semana3: { activaciones: 20, renovaciones: 6, seguros: 4, simples: 1, accessFee: 577.33 }},
    { tienda: "EXP KSK PATIO TEXCOCO", zona: "Norte", semana1: { activaciones: 11, renovaciones: 7, seguros: 2, simples: 0, accessFee: 527.89 }, semana2: { activaciones: 8, renovaciones: 1, seguros: 2, simples: 0, accessFee: 525.67 }, semana3: { activaciones: 9, renovaciones: 4, seguros: 0, simples: 0, accessFee: 600.54 }},
    { tienda: "EXP KSK SENDERO IXTAPALUCA", zona: "Sur", semana1: { activaciones: 14, renovaciones: 7, seguros: 5, simples: 0, accessFee: 621.86 }, semana2: { activaciones: 12, renovaciones: 0, seguros: 2, simples: 0, accessFee: 602.00 }, semana3: { activaciones: 12, renovaciones: 3, seguros: 7, simples: 0, accessFee: 583.62 }},
    { tienda: "EXP NAUCALPAN", zona: "Norte", semana1: { activaciones: 7, renovaciones: 2, seguros: 0, simples: 0, accessFee: 759.00 }, semana2: { activaciones: 12, renovaciones: 4, seguros: 1, simples: 0, accessFee: 637.57 }, semana3: { activaciones: 5, renovaciones: 1, seguros: 0, simples: 0, accessFee: 455.67 }},
    { tienda: "EXP PATIO TLALPAN", zona: "Sur", semana1: { activaciones: 14, renovaciones: 6, seguros: 3, simples: 0, accessFee: 557.13 }, semana2: { activaciones: 20, renovaciones: 12, seguros: 1, simples: 5, accessFee: 552.85 }, semana3: { activaciones: 13, renovaciones: 5, seguros: 2, simples: 0, accessFee: 652.13 }},
    { tienda: "EXP PLAZA TOLLOCAN", zona: "Sur", semana1: { activaciones: 8, renovaciones: 0, seguros: 0, simples: 0, accessFee: 491.50 }, semana2: { activaciones: 7, renovaciones: 0, seguros: 0, simples: 0, accessFee: 504.71 }, semana3: { activaciones: 6, renovaciones: 0, seguros: 0, accessFee: 682.33 }},
    { tienda: "EXP SENDERO TOLUCA II", zona: "Sur", semana1: { activaciones: 17, renovaciones: 6, seguros: 1, simples: 0, accessFee: 608.00 }, semana2: { activaciones: 25, renovaciones: 6, seguros: 4, simples: 0, accessFee: 644.38 }, semana3: { activaciones: 23, renovaciones: 4, seguros: 2, simples: 0, accessFee: 609.45 }},
    { tienda: "EXP TDA CDMX MULTIPLAZA ARAGON", zona: "Norte", semana1: { activaciones: 20, renovaciones: 1, seguros: 0, simples: 0, accessFee: 474.88 }, semana2: { activaciones: 23, renovaciones: 2, seguros: 4, simples: 0, accessFee: 543.55 }, semana3: { activaciones: 27, renovaciones: 1, seguros: 4, simples: 0, accessFee: 510.48 }},
    { tienda: "EXP TOWN CENTER NICOLAS ROMERO DFN", zona: "Norte", semana1: { activaciones: 37, renovaciones: 27, seguros: 6, simples: 0, accessFee: 663.50 }, semana2: { activaciones: 36, renovaciones: 14, seguros: 8, simples: 0, accessFee: 563.38 }, semana3: { activaciones: 31, renovaciones: 9, seguros: 7, simples: 4, accessFee: 634.25 }},
  ];

  // Variables para las listas de tiendas, como en tu código
  ...
  const totales = useMemo(() => {
    ...
    return {
      totalActivaciones: sumReducer('activaciones'), totalRenovaciones: sumReducer('renovaciones'),
      totalSeguros: sumReducer('seguros'), totalSimples: sumReducer('simples'),
  ...
  const zoneSummaryData = useMemo(() => {
    const metrics = [
      { key: 'activaciones', name: 'Activaciones' }, { key: 'renovaciones', name: 'Renovaciones' },
      { key: 'seguros', name: 'Seguros' }, { key: 'simples', name: 'Simples Emp.' },
    ];
    const calculateTotals = (zona) => metrics.map(metric => ({
        metric: metric.name,
        total: dashboardData.filter(d => d.zona === zona).reduce((sum, item) => sum + item.semana1[metric.key] + item.semana2[metric.key] + item.semana3[metric.key], 0)
    }));
  ...
  const DetailsTable = ({ tienda }) => {
    ...
    return (
      <div className="text-xs sm:text-sm bg-white p-3 rounded-lg border mt-2">
        ...
        {categories.map(cat => {
          const s1 = tienda.semana1[cat]; const s2 = tienda.semana2[cat]; const s3 = tienda.semana3[cat];
  ...
  const getStoreSummaryData = (tienda) => {
    ...
    return metrics.map(metric => ({
      metric: metric.name,
      total: parseFloat((tienda.semana1[metric.key] + tienda.semana2[metric.key] + tienda.semana3[metric.key]).toFixed(2))
    }));
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
            <img src={logoIzquierda} alt="Logo Izquierdo" className="h-12 w-auto" />
            <div className="text-center">
                <h1 className="text-4xl font-bold text-slate-800">Región Centro</h1>
            </div>
            <img src={logoDerecha} alt="Logo Derecho" className="h-12 w-auto" />
        </div>
            ...
            {showComparisons && (
                <div className="mt-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <CategoryComparisonChart title="Access Fee (Suma)" data={categoryComparisonData.accessFee} color="#8B5CF6" />
                    </div>
                </div>
            )}
        </div>
...
export default Dashboard;import React, { useState, useMemo } from 'react';
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from 'recharts';
import { ChevronDown, ChevronUp, Store, TrendingUp, DollarSign, Users, Shield, Building } from 'lucide-react';
